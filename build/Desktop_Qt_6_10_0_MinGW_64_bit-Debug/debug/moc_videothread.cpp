...
template <> constexpr inline auto VideoThread::qt_create_metaobjectdata<qt_meta_tag_ZN11VideoThreadE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'frameReady'
        QtMocHelpers::SignalData<void(uchar *, uchar *, uchar *, int, int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->frameReady((*reinterpret_cast<std::add_pointer_t<uchar*>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uchar*>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<uchar*>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[5]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoThread::*)(uchar * , uchar * , uchar * , int , int )>(_a, &VideoThread::frameReady, 0))
            return;
    }
}
...
// SIGNAL 0
void VideoThread::frameReady(uchar * _t1, uchar * _t2, uchar * _t3, int _t4, int _t5)
{
